...
echo "Submit job = start:$start_row, end:$end_row, replicates:$reps"
...
bsub -n 1 -W 7200 -R span[hosts=1] -R "rusage[mem=10]" -q cnr -oo out.02_main_test.$rep -eo err.02_main_test.$rep "Rscript 02_main.R $start_row $end_row $reps"
